...
const node_session_secret = '95ccab4b-318f-4d3b-83af-f103f23d7b23'
...
app.get('/members', (req, res) => {
    ...
    console.log(`<h1>Hello ${name} </h1> <img src ="/thug${randomInteger}.jpeg"><a href="/logout"><button>Log Out</button></a>`)
})
...
app.use((req, res) => {
    res.status(404).send("404: Psage not found");
  });
